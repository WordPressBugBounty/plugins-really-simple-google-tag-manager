...
<?php
$info_data = \RealySimleGoogleTag\Admin\Dashboard_Widget_Api::get_remote_data();
        ...
        <ul>
            <li>
                <a href="https://hasthemes.com/blog/" target="_blank">
                    <?php esc_html_e( 'Blog', 'simple-googletag' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/docs/" target="_blank">
                    <?php esc_html_e( 'Documentation', 'simple-googletag' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/contact-us/" target="_blank">
                    <?php esc_html_e( 'Support', 'simple-googletag' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
        </ul>
