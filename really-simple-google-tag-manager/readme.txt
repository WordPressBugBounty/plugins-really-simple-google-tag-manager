...
== Description ==
Google Tag Manager is a tag management system (TMS) that allows us to easily update marketing tag snippets/codes/tracking pixel on a website. It helps to manage website tags without editing code of a themes.

Manager gives you the ability to add and update your own tags for conversion tracking, site analytics, remarketing, and more. There are nearly endless ways to track activity across your sites and apps, and the intuitive design lets you change tags whenever you want. It helps to deploy Google and third-party tags easily.

Reallly Simple Google Tag Manager WordPress plugin is developed by [HasThemes](https://hasthemes.com/) team to add the Google Tag Manager Script to a theme code without touching any code. It makes easier to enable or disable the tracking code.
...
= Version: 1.0.7 - Date: 2023-04-06 =
* Added: Nonce verification for recommended plugins
* Improved: Coding standards in some areas

= Version: 1.0.6 - Date: 2022-11-03 =
* Compatibility with the latest WordPress version.

= Version: 1.0.5 - Date: 2022-09-13 =
* Added: Recommendations submenu.

= Version: 1.0.4 - Date: 2022-06-20 =
* Compatibility with latest WordPress version.

= Version: 1.0.3 - Date: 2022-02-09 =
* Compatibility with latest WordPress version.

= Version: 1.0.2 - Date: 2021-07-25 =
* Compatibility with latest WordPress version.

= Version: 1.0.1 - Date: 2021-03-14 =
* Compatibility with latest wordpress version.

= Version: 1.0.0 - Date: 2020-12-15 =
* Initial Upload.

== Installation ==
This section describes how to install the Really Simple Google Tag Manager Plugins for WordPress get it working.

= 1) Install =

1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "Really Simple Google Tag Manager".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `really-simple-google-tag-manager` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. Go to the Google Tag Manager Settings Options.
